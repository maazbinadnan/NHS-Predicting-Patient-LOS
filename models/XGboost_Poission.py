...
class TrainXGBoostPoissonRegressor(model_interface):
    ...
    def train_model_with_params(self, train: pd.DataFrame, test: pd.DataFrame, **kwargs):
        ...
        # initialize XGBoost Poisson Regressor with given params
        ...
        print("--- XGBoost Poisson Model Evaluation ---")
    ...
    def evaluate_model(self, original_values, predictions):
        ...
        print("--- Evaluation (XGBoost Poisson Regression) ---")
        print(f"RMSE: {rmse:.4f}")
        print(f"MAE:  {mae:.4f}")
        print(f"R²:   {r2:.4f}")
    ...
    def fine_tune_model(self, train: pd.DataFrame, test: pd.DataFrame, filepath: str):
        ...
        print("\n--- Starting Hyperparameter Tuning for XGBoost Poisson ---")
        ...
        print("\n--- Fine-Tuned XGBoost Poisson Model Evaluation ---")
        ...
        with open(filepath, "w") as f:
            f.write("# XGBoost Poisson Regression Results\n\n")
